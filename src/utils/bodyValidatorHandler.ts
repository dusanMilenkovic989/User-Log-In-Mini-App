...
/**
 * Utility higher order function which passes request body properties list, provided as argument, to bodyValidator middleware and returns it. 
 * 
 * Middleware will assert the existence of the request body and the properties on it.
